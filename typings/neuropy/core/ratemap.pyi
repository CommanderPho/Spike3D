...
class Ratemap(HDFMixin, NeuronIdentitiesDisplayerMixin, RatemapPlottingMixin, ContinuousPeakLocationRepresentingMixin, PeakLocationRepresentingMixin, NeuronUnitSlicableObjectProtocol, BinnedPositionsMixin, DataWriter):
    ...
    def compute_tuning_curve_modes(self, peak_mode=..., **find_peaks_kwargs) -> Tuple[Dict[types.aclu_index, NDArray], Dict[types.aclu_index, int], pd.DataFrame]:
    ...
    def get_tuning_curve_peak_df(self, peak_mode=..., **find_peaks_kwargs) -> pd.DataFrame:
    ...
    def get_sort_indicies(self, sortby=...) -> NDArray:
        ...
