...
class DatovizExampleBrowser(QMainWindow):
    """Interactive browser for Datoviz examples, analogous to Vispy/Silx Examples Browser"""

    def __init__(self):
        super().__init__()
        self.setWindowTitle("Datoviz Examples Browser")
    ...
    def _load_favorites(self):
        ...
        settings = QSettings("Spike3D", "DatovizExampleBrowser")
