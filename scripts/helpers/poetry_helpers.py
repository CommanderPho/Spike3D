...
## TODO 2023-05-26 - UNFINISHED

def get_current_poetry_env(working_dir=None) -> str:
    if working_dir is not None:
        curr_env_path = os.system(f'poetry env list --full-path --directory={working_dir}')
    else:
        curr_env_path = os.system('poetry env list --full-path') # use the current working directory
