...
# + [markdown] tags=["load", "single_session"] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true
...
# + [markdown] jupyter={"outputs_hidden": false} jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true
...
# + [markdown] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true
# ### Burst Detection
# -
...
# + [markdown] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[]
...
# + [markdown] pycharm={"name": "#%%\n"} tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[] jp-MarkdownHeadingCollapsed=true tags=[]
...
# ## 🔝 2023-02-23 - Updating decoding of custom epochs visualizations
...
# Estimate replays instead of using the loaded ones:
long_replay_df, short_replay_df, global_replay_df = [a_session.estimate_replay_epochs(min_epoch_included_duration=0.06, max_epoch_included_duration=None, maximum_speed_thresh=None, min_inclusion_fr_active_thresh=0.0, min_num_unique_aclu_inclusions=3).to_dataframe() for a_session in [long_session, short_session, global_session]]
# long_replay_df, short_replay_df, global_replay_df = [a_session.estimate_replay_epochs(min_epoch_included_duration=0.06, max_epoch_included_duration=0.6, maximum_speed_thresh=2.0, min_inclusion_fr_active_thresh=1.0, min_num_unique_aclu_inclusions=3).to_dataframe().epochs.get_epochs_longer_than(decoding_time_bin_size*2.0, debug_print=True) for a_session in [long_session, short_session, global_session]]
...
# Compute the posterior maximum confidence as a proxy for decoding quality/certainty:
...
def _plot_decoding_maximum_posterior_confidence(long_one_step_decoder_1D, short_one_step_decoder_1D, long_posterior_uncertainty_measure, short_posterior_uncertainty_measure, long_decoding_of_long_epochs_results, short_decoding_of_short_epochs_results, long_decoding_of_short_epochs_results, short_decoding_of_long_epochs_results):
    """ plots the scatter plot of the maximum posterior confidence value for each of the four decoding methods (longD-long, longD-short, shortD-long, shortD-short) where 'D' indicates decoder. """
    fig, ax = plt.subplots()
...
fig, ax = _plot_decoding_maximum_posterior_confidence(long_one_step_decoder_1D, short_one_step_decoder_1D, long_posterior_uncertainty_measure, short_posterior_uncertainty_measure, long_decoding_of_long_epochs_results, short_decoding_of_short_epochs_results, long_decoding_of_short_epochs_results, short_decoding_of_long_epochs_results)
# -

# ### Plot multiple decoded_epoch_slices widgets side-by-side to allow comparison between the decoding of each epoch by the two different decoders (longD and shortD)

# +
from pyphoplacecellanalysis.General.Pipeline.Stages.DisplayFunctions.DecoderPredictionError import plot_decoded_epoch_slices

## Add `.epoch_description_list` to the decoding results as this is required by `plot_decoded_epoch_slices`:

# decoded 'long' epochs will share epoch_description_list:
long_decoding_of_long_epochs_results.epoch_description_list = [f'{epoch_tuple.label}' for epoch_tuple in long_replay_df[['label']].itertuples()]
short_decoding_of_long_epochs_results.epoch_description_list = [f'{epoch_tuple.label}' for epoch_tuple in long_replay_df[['label']].itertuples()]

# decoded 'short' epochs will share epoch_description_list:
long_decoding_of_short_epochs_results.epoch_description_list = [f'{epoch_tuple.label}' for epoch_tuple in short_replay_df[['label']].itertuples()]
short_decoding_of_short_epochs_results.epoch_description_list = [f'{epoch_tuple.label}' for epoch_tuple in short_replay_df[['label']].itertuples()]


# short_one_step_decoder_1D, short_decoding_of_long_epochs_results
# params, plots_data, plots, ui = plot_decoded_epoch_slices(long_replay_df, short_decoding_of_long_epochs_results, global_pos_df=sess.position.to_dataframe(), xbin=short_one_step_decoder_1D.xbin, enable_flat_line_drawing=False, debug_test_max_num_slices=20, debug_print=False)
params_left, plots_data_left, plots_left, ui_left = plot_decoded_epoch_slices(long_replay_df, short_decoding_of_long_epochs_results, global_pos_df=sess.position.to_dataframe(), xbin=short_one_step_decoder_1D.xbin, enable_flat_line_drawing=False, debug_test_max_num_slices=20, debug_print=False)

# long_decoding_of_short_epochs_results.
params_right, plots_data_right, plots_right, ui_right = plot_decoded_epoch_slices(long_replay_df, long_decoding_of_long_epochs_results, global_pos_df=sess.position.to_dataframe(), xbin=long_one_step_decoder_1D.xbin, enable_flat_line_drawing=False, debug_test_max_num_slices=20, debug_print=False)


# long_decoding_of_long_epochs_results

# curr_active_pipeline.display(display_function='plot_decoded_epoch_slices')
