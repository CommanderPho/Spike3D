{
	"name": "PicklingError",
	"message": "Can't pickle <class 'neuropy.core.session.Formats.BaseDataSessionFormats.DataSessionFormatBaseRegisteredClass'>: it's not the same object as neuropy.core.session.Formats.BaseDataSessionFormats.DataSessionFormatBaseRegisteredClass",
	"stack": "---------------------------------------------------------------------------
...
--> 717         save(state)
    ...
    [... skipping similar frames: _Pickler.save at line 560 (1 times)]
...
File c:\\Users\\pho\\repos\\Spike3DWorkEnv\\Spike3D\\.venv\\lib\\site-packages\\dill\\_dill.py:1851, in save_type(pickler, obj, postproc_list)
   1847             warnings.warn('Cannot pickle %r: %s.%s has recursive self-references that trigger a RecursionError.' % (obj, obj.__module__, obj_name), PicklingWarning)
   1848        #print (obj.__dict__)
   1849        #print (\"%s\
%s\" % (type(obj), obj.__name__))
   1850        #print (\"%s\
%s\" % (obj.__bases__, obj.__dict__))
-> 1851         StockPickler.save_global(pickler, obj, name=obj_name)
   1852         log.info(\"# T4\")
   1853 return

File ~\\.pyenv\\pyenv-win\\versions\\3.9.13\\lib\\pickle.py:1075, in _Pickler.save_global(self, obj, name)
   1073 else:
...
PicklingError: Can't pickle <class 'neuropy.core.session.Formats.BaseDataSessionFormats.DataSessionFormatBaseRegisteredClass'>: it's not the same object as neuropy.core.session.Formats.BaseDataSessionFormats.DataSessionFormatBaseRegisteredClass"
}