2022-02-01 02:25:51  (rev 0)
    ...
    +dask-core-2021.10.0 (defaults/noarch)
    ...
    +jasper-2.0.33 (conda-forge/win-64)
    ...
    +m2w64-gmp-6.1.0 (conda-forge/win-64)
...
2022-03-08 08:25:40  (rev 58)
    ...
    +m2w64-libtasn1-4.7 (conda-forge/win-64)
...
2022-03-25 21:37:14  (rev 86)
    ...
    +pyjwt-2.3.0 (conda-forge/noarch)
...
2022-07-07 23:54:26  (rev 166)
     openssl  {1.1.1p (conda-forge/win-64) -> 1.1.1q (conda-forge/win-64)}
    +fabio-0.14.0 (conda-forge/win-64)
    +glymur-0.10.1 (conda-forge/noarch)
    +libxslt-1.1.33 (conda-forge/win-64)
    +lxml-4.8.0 (conda-forge/win-64)
    +silx-1.0.0 (conda-forge/noarch)
    +silx-base-1.0.0 (conda-forge/win-64)

2022-07-07 23:59:32  (rev 167)
    +hdf5plugin-3.3.1 (conda-forge/win-64)

2022-07-08 00:00:30  (rev 168)
    +goosehdf5-0.17.1 (conda-forge/noarch)

2022-07-08 03:56:25  (rev 169)
     pandas  {1.4.2 (conda-forge/win-64) -> 1.4.3 (conda-forge/win-64)}

2022-07-10 03:03:37  (rev 170)
     imageio  {2.19.2 (conda-forge/noarch) -> 2.19.3 (conda-forge/noarch)}
     ipykernel  {6.15.0 (conda-forge/noarch) -> 6.15.1 (conda-forge/noarch)}
     jupyter_server  {1.18.0 (conda-forge/noarch) -> 1.18.1 (conda-forge/noarch)}
     jupyterlab_server  {2.14.0 (conda-forge/noarch) -> 2.15.0 (conda-forge/noarch)}
     kiwisolver  {1.3.2 (conda-forge/win-64) -> 1.4.3 (conda-forge/win-64)}

2022-07-10 03:33:32  (rev 171)
     icu  {68.2 (conda-forge/win-64) -> 69.1 (conda-forge/win-64)}
     libclang  {11.1.0 (conda-forge/win-64) -> 13.0.1 (conda-forge/win-64)}
     qt  {5.12.9 (conda-forge/win-64) -> 5.12.9 (conda-forge/win-64)}

2022-07-12 15:55:45  (rev 172)
    +line_profiler-3.4.0 (conda-forge/win-64)
    +memory_profiler-0.60.0 (conda-forge/noarch)
    +pyinstrument-4.2.0 (conda-forge/win-64)

2022-07-19 12:33:18  (rev 173)
     pyinstaller-hooks-contrib  {2022.5 (conda-forge/noarch) -> 2022.8 (conda-forge/noarch)}
     qdarkstyle  {3.0.3 (conda-forge/noarch) -> 3.1 (conda-forge/noarch)}

2022-07-19 17:08:00  (rev 174)
     setuptools  {63.1.0 (conda-forge/win-64) -> 63.2.0 (conda-forge/win-64)}
     setuptools-scm  {6.4.2 (conda-forge/noarch) -> 7.0.5 (conda-forge/noarch)}
     setuptools_scm  {6.4.2 (conda-forge/noarch) -> 7.0.5 (conda-forge/noarch)}

2022-07-19 17:08:29  (rev 175)
     python  {3.9.12 (conda-forge/win-64) -> 3.9.13 (conda-forge/win-64)}
     sqlite  {3.37.2 (defaults/win-64) -> 3.39.1 (conda-forge/win-64)}

2022-07-19 17:25:58  (rev 176)
    -asciitree-0.3.3 (conda-forge/noarch)
    -cachey-0.2.1 (conda-forge/noarch)
    -docstring_parser-0.13 (conda-forge/noarch)
    -fasteners-0.17.3 (conda-forge/noarch)
...
2022-07-19 17:26:29  (rev 177)
     libpython  {2.1 (conda-forge/win-64) -> 2.2 (conda-forge/win-64)}

2022-07-19 17:31:01  (rev 178)
     platformdirs  {2.5.1 (conda-forge/noarch) -> 2.5.2 (conda-forge/noarch)}
     virtualenv  {20.13.3 (conda-forge/win-64) -> 20.15.1 (conda-forge/win-64)}

2022-07-19 17:33:55  (rev 179)
     cupy  {10.5.0 (conda-forge/win-64) -> 10.6.0 (conda-forge/win-64)}

2022-07-19 17:41:00  (rev 180)
     jupyter-server-mathjax  {0.2.5 (conda-forge/noarch) -> 0.2.6 (conda-forge/noarch)}
     nbclassic  {0.3.7 (conda-forge/noarch) -> 0.4.3 (conda-forge/noarch)}

2022-07-19 17:43:38  (rev 181)
    -click-completion-0.5.2 (conda-forge/win-64)
    -click-log-0.3.2 (conda-forge/noarch)
    -gitdb-4.0.9 (conda-forge/noarch)
    -gitpython-3.1.27 (conda-forge/noarch)
...
2022-07-19 17:51:42  (rev 182)
     jsonschema  {3.2.0 (conda-forge/noarch) -> 4.7.2 (conda-forge/noarch)}
     nbclient  {0.5.13 (conda-forge/noarch) -> 0.6.6 (conda-forge/noarch)}
     nested-lookup  {0.2.23 (conda-forge/noarch) -> 0.2.25 (conda-forge/noarch)}
     nodejs  {17.9.0 (conda-forge/win-64) -> 18.6.0 (conda-forge/win-64)}

2022-07-19 17:54:09  (rev 183)
     jupyter-sphinx  {0.3.2 (conda-forge/noarch) -> 0.4.0 (conda-forge/noarch)}

2022-07-19 17:57:35  (rev 184)
    +pyopengl-3.1.6 (conda-forge/noarch)

2022-08-02 03:40:57  (rev 185)
     arviz  {0.11.4 (conda-forge/noarch) -> 0.12.1 (conda-forge/noarch)}
     typing-extensions  {3.10.0.2 (conda-forge/noarch) -> 4.3.0 (conda-forge/noarch)}
     typing_extensions  {3.10.0.2 (conda-forge/noarch) -> 4.3.0 (conda-forge/noarch)}
     vaex-core  {4.8.0 (conda-forge/win-64) -> 4.11.1 (conda-forge/win-64)}
    +astropy-5.1 (conda-forge/win-64)
    +bqplot-0.12.33 (conda-forge/noarch)
    +ipydatawidgets-4.3.1.post1 (conda-forge/noarch)
    +ipyleaflet-0.17.0 (conda-forge/noarch)
    +ipympl-0.9.1 (conda-forge/noarch)
    +ipyvolume-0.6.0a8 (conda-forge/noarch)
    +ipyvue-1.7.0 (conda-forge/noarch)
    +ipyvuetify-1.8.2 (conda-forge/noarch)
    +ipywebrtc-0.6.0 (conda-forge/noarch)
    +polars-0.13.58 (conda-forge/win-64)
    +pyerfa-2.0.0.1 (conda-forge/win-64)
    +pythreejs-2.3.0 (conda-forge/noarch)
    +traittypes-0.2.1 (conda-forge/noarch)
    +vaex-4.11.1 (conda-forge/noarch)
    +vaex-astro-0.9.1 (conda-forge/noarch)
    +vaex-hdf5-0.12.3 (conda-forge/noarch)
    +vaex-jupyter-0.8.0 (conda-forge/noarch)
    +vaex-ml-0.18.0 (conda-forge/noarch)
    +vaex-ui-0.3.0 (conda-forge/noarch)
    +vaex-viz-0.5.2 (conda-forge/noarch)
    +xarray-einstats-0.3.0 (conda-forge/noarch)
    +xyzservices-2022.6.0 (conda-forge/noarch)

2022-08-02 03:43:33  (rev 186)
     dask  {2022.4.1 (conda-forge/noarch) -> 2022.7.1 (conda-forge/noarch)}
     dask-core  {2022.4.1 (conda-forge/noarch) -> 2022.7.1 (conda-forge/noarch)}
     distributed  {2022.4.1 (conda-forge/noarch) -> 2022.7.1 (conda-forge/noarch)}
     locket  {0.2.1 (defaults/win-64) -> 1.0.0 (conda-forge/noarch)}

2022-08-02 04:18:19  (rev 187)
     numexpr  {2.8.1 (defaults/win-64) -> 2.8.3 (defaults/win-64)}
    +bottleneck-1.3.5 (conda-forge/win-64)

2022-08-04 16:17:30  (rev 188)
    +alive-progress-1.6.2 (conda-forge/noarch)

2022-08-04 16:34:11  (rev 189)
    -alive-progress-1.6.2 (conda-forge/noarch)

2022-08-09 00:44:15  (rev 190)
    +dill-0.3.5.1 (conda-forge/noarch)

2022-08-09 01:30:19  (rev 191)
    -dill-0.3.5.1 (conda-forge/noarch)

2022-08-09 01:31:49  (rev 192)
    +dill-0.3.5.1 (conda-forge/noarch)

2022-08-09 07:07:47  (rev 193)
     jupyterlab  {3.4.3 (conda-forge/noarch) -> 3.4.4 (conda-forge/noarch)}

2022-08-10 17:39:30  (rev 194)
    +pyqtads-3.8.2 (conda-forge/win-64)

2022-08-16 01:54:53  (rev 195)
     frozenlist  {1.3.0 (conda-forge/win-64) -> 1.3.1 (conda-forge/win-64)}

2022-08-16 01:57:51  (rev 196)
     hdf5  {1.12.1 (conda-forge/win-64) -> 1.12.1 (conda-forge/win-64)}
     jupyter_core  {4.10.0 (conda-forge/win-64) -> 4.11.1 (conda-forge/win-64)}
     jupyterlab  {3.4.4 (conda-forge/noarch) -> 3.4.5 (conda-forge/noarch)}
     kiwisolver  {1.4.3 (conda-forge/win-64) -> 1.4.4 (conda-forge/win-64)}
     nbconvert  {6.5.0 (conda-forge/noarch) -> 6.5.3 (conda-forge/noarch)}
     nbconvert-core  {6.5.0 (conda-forge/noarch) -> 6.5.3 (conda-forge/noarch)}
     nbconvert-pandoc  {6.5.0 (conda-forge/noarch) -> 6.5.3 (conda-forge/noarch)}
     pip  {22.1.2 (conda-forge/noarch) -> 22.2.2 (conda-forge/noarch)}

2022-08-16 09:17:00  (rev 197)
     boa  {0.11.0 (conda-forge/noarch) -> 0.11.0 (conda-forge/noarch)}
     cachetools  {5.0.0 (conda-forge/noarch) -> 5.2.0 (conda-forge/noarch)}
     conda-build  {3.21.9 (conda-forge/win-64) -> 3.22.0 (conda-forge/win-64)}
     coverage  {6.4.1 (conda-forge/win-64) -> 6.4.3 (conda-forge/win-64)}
     cupy  {10.6.0 (conda-forge/win-64) -> 11.0.0 (conda-forge/win-64)}
     cython  {0.29.30 (conda-forge/win-64) -> 0.29.32 (conda-forge/win-64)}
     cytoolz  {0.11.2 (conda-forge/win-64) -> 0.12.0 (conda-forge/win-64)}

2022-08-28 17:18:14  (rev 198)
     certifi  {2022.6.15 (conda-forge/win-64) -> 2022.6.15 (conda-forge/noarch)}
    -fonttools-4.29.1 (conda-forge/win-64)
    -pillow-8.4.0 (conda-forge/win-64)

2022-08-28 17:20:37  (rev 199)
     black  {22.3.0 (conda-forge/noarch) -> 22.6.0 (conda-forge/win-64)}

2022-08-28 17:21:40  (rev 200)
     conda  {4.13.0 (conda-forge/win-64) -> 4.14.0 (conda-forge/win-64)}

2022-08-28 17:22:52  (rev 201)
     markdown  {3.3.6 (conda-forge/noarch) -> 3.4.1 (conda-forge/noarch)}
...
2022-08-28 17:24:38  (rev 202)
     scipy  {1.7.3 (conda-forge/win-64) -> 1.9.0 (conda-forge/win-64)}
     setuptools  {63.2.0 (conda-forge/win-64) -> 65.3.0 (conda-forge/noarch)}

2022-08-28 17:25:42  (rev 203)
     click  {8.0.3 (conda-forge/win-64) -> 8.1.3 (conda-forge/win-64)}
     configupdater  {3.1 (conda-forge/noarch) -> 3.1.1 (conda-forge/noarch)}

2022-08-28 17:26:46  (rev 204)
     bqplot  {0.12.33 (conda-forge/noarch) -> 0.12.34 (conda-forge/noarch)}
     ipydatawidgets  {4.3.1.post1 (conda-forge/noarch) -> 4.3.2 (conda-forge/noarch)}
     ipyleaflet  {0.17.0 (conda-forge/noarch) -> 0.17.1 (conda-forge/noarch)}
     ipympl  {0.9.1 (conda-forge/noarch) -> 0.9.2 (conda-forge/noarch)}
     ipywidgets  {7.7.1 (conda-forge/noarch) -> 8.0.1 (conda-forge/noarch)}
     jupyterlab_server  {2.15.0 (conda-forge/noarch) -> 2.15.1 (conda-forge/noarch)}
     jupyterlab_widgets  {1.1.1 (conda-forge/noarch) -> 3.0.2 (conda-forge/noarch)}
     pythreejs  {2.3.0 (conda-forge/noarch) -> 2.4.0 (conda-forge/noarch)}
     widgetsnbextension  {3.6.1 (conda-forge/noarch) -> 4.0.2 (conda-forge/noarch)}
    +branca-0.5.0 (conda-forge/noarch)
    +libwebp-1.2.2 (conda-forge/win-64)
    +libxcb-1.13 (conda-forge/win-64)
    +pillow-9.1.1 (conda-forge/win-64)
    +pthread-stubs-0.4 (conda-forge/win-64)
    +xorg-libxau-1.0.9 (conda-forge/win-64)
    +xorg-libxdmcp-1.1.3 (conda-forge/win-64)

2022-08-28 17:27:50  (rev 205)
     etuples  {0.3.4 (conda-forge/noarch) -> 0.3.5 (conda-forge/noarch)}
     executing  {0.8.3 (conda-forge/noarch) -> 0.10.0 (conda-forge/noarch)}
     fastapi  {0.75.0 (conda-forge/noarch) -> 0.81.0 (conda-forge/noarch)}
     fastcore  {1.3.29 (conda-forge/noarch) -> 1.5.22 (conda-forge/noarch)}
     fastprogress  {1.0.2 (conda-forge/noarch) -> 1.0.3 (conda-forge/noarch)}
     starlette  {0.17.1 (conda-forge/noarch) -> 0.19.1 (conda-forge/noarch)}

2022-08-28 17:28:56  (rev 206)
     blosc  {1.21.0 (conda-forge/win-64) -> 1.21.1 (conda-forge/win-64)}
     c-blosc2  {2.0.4 (conda-forge/win-64) -> 2.3.1 (conda-forge/win-64)}
     cfitsio  {4.0.0 (conda-forge/win-64) -> 4.1.0 (conda-forge/win-64)}
     imagecodecs  {2022.2.22 (conda-forge/win-64) -> 2022.8.8 (conda-forge/win-64)}
     lerc  {3.0 (conda-forge/win-64) -> 4.0.0 (conda-forge/win-64)}
     libavif  {0.9.3 (conda-forge/win-64) -> 0.10.1 (conda-forge/win-64)}
     libdeflate  {1.10 (conda-forge/win-64) -> 1.13 (conda-forge/win-64)}
     libtiff  {4.3.0 (conda-forge/win-64) -> 4.4.0 (conda-forge/win-64)}
     libwebp  {1.2.2 (conda-forge/win-64) -> 1.2.4 (conda-forge/win-64)}
     libwebp-base  {1.2.2 (conda-forge/win-64) -> 1.2.4 (conda-forge/win-64)}
     libzlib  {1.2.11 (conda-forge/win-64) -> 1.2.12 (conda-forge/win-64)}
     openjpeg  {2.4.0 (conda-forge/win-64) -> 2.5.0 (conda-forge/win-64)}
     pillow  {9.1.1 (conda-forge/win-64) -> 9.2.0 (conda-forge/win-64)}
     snappy  {1.1.8 (conda-forge/win-64) -> 1.1.9 (conda-forge/win-64)}
     xz  {5.2.5 (conda-forge/win-64) -> 5.2.6 (conda-forge/win-64)}
     zfp  {0.5.5 (conda-forge/win-64) -> 1.0.0 (conda-forge/win-64)}
     zlib  {1.2.11 (conda-forge/win-64) -> 1.2.12 (conda-forge/win-64)}
    +zlib-ng-2.0.6 (conda-forge/win-64)

2022-08-28 17:30:44  (rev 207)
     scikit-image  {0.19.2 (conda-forge/win-64) -> 0.19.3 (conda-forge/win-64)}
     scikit-learn  {1.0.2 (conda-forge/win-64) -> 1.1.2 (conda-forge/win-64)}

2022-08-28 17:31:40  (rev 208)
     dask  {2022.7.1 (conda-forge/noarch) -> 2022.8.1 (conda-forge/noarch)}
     dask-core  {2022.7.1 (conda-forge/noarch) -> 2022.8.1 (conda-forge/noarch)}
     distributed  {2022.7.1 (conda-forge/noarch) -> 2022.8.1 (conda-forge/noarch)}

2022-08-28 17:33:11  (rev 209)
     pyqt-builder  {1.12.2 (conda-forge/noarch) -> 1.13.0 (conda-forge/noarch)}

2022-08-28 17:34:55  (rev 210)
     arrow-cpp  {3.0.0 (conda-forge/win-64) -> 9.0.0 (conda-forge/win-64)}
     glog  {0.5.0 (conda-forge/win-64) -> 0.6.0 (conda-forge/win-64)}
     grpc-cpp  {1.45.0 (conda-forge/win-64) -> 1.46.4 (conda-forge/win-64)}
     libopencv  {4.5.5 (conda-forge/win-64) -> 4.5.5 (conda-forge/win-64)}
     libprotobuf  {3.19.4 (conda-forge/win-64) -> 3.20.1 (conda-forge/win-64)}
     libthrift  {0.15.0 (conda-forge/win-64) -> 0.16.0 (conda-forge/win-64)}
     numpydoc  {1.2.1 (conda-forge/noarch) -> 1.4.0 (conda-forge/noarch)}
     opencv  {4.5.5 (conda-forge/win-64) -> 4.5.5 (conda-forge/win-64)}
     protobuf  {3.19.4 (conda-forge/win-64) -> 3.20.1 (conda-forge/win-64)}
     py-opencv  {4.5.5 (conda-forge/win-64) -> 4.5.5 (conda-forge/win-64)}
     pyarrow  {3.0.0 (conda-forge/win-64) -> 9.0.0 (conda-forge/win-64)}
     re2  {2022.02.01 (conda-forge/win-64) -> 2022.06.01 (conda-forge/win-64)}
    +libcrc32c-1.1.2 (conda-forge/win-64)
    +libgoogle-cloud-1.40.2 (conda-forge/win-64)

2022-08-28 17:36:11  (rev 211)
     freetype  {2.10.4 (conda-forge/win-64) -> 2.12.1 (conda-forge/win-64)}
     freetype-py  {2.2.0 (conda-forge/noarch) -> 2.3.0 (conda-forge/noarch)}
     frozendict  {2.3.2 (conda-forge/win-64) -> 2.3.4 (conda-forge/win-64)}

2022-08-28 17:39:08  (rev 212)
     fsspec  {2022.5.0 (conda-forge/noarch) -> 2022.7.1 (conda-forge/noarch)}

2022-08-28 17:43:38  (rev 213)
     boa  {0.11.0 (conda-forge/noarch) -> 0.11.0 (conda-forge/noarch)}
     libmamba  {0.24.0 (conda-forge/win-64) -> 0.25.0 (conda-forge/win-64)}
     libmambapy  {0.24.0 (conda-forge/win-64) -> 0.25.0 (conda-forge/win-64)}
     mamba  {0.24.0 (conda-forge/win-64) -> 0.25.0 (conda-forge/win-64)}

2022-08-28 17:46:35  (rev 214)
     chardet  {4.0.0 (conda-forge/win-64) -> 5.0.0 (conda-forge/win-64)}

2022-08-28 17:47:51  (rev 215)
     mako  {1.2.0 (conda-forge/noarch) -> 1.2.1 (conda-forge/noarch)}
     markupsafe  {2.0.1 (conda-forge/win-64) -> 2.1.1 (conda-forge/win-64)}

2022-08-28 17:49:35  (rev 216)
     pyinstrument  {4.2.0 (conda-forge/win-64) -> 4.3.0 (conda-forge/win-64)}

2022-08-28 17:52:01  (rev 217)
     vaex-viz  {0.5.2 (conda-forge/noarch) -> 0.5.3 (conda-forge/noarch)}

2022-08-28 17:53:33  (rev 218)
     scooby  {0.5.12 (conda-forge/noarch) -> 0.6.0 (conda-forge/noarch)}

2022-08-28 17:55:45  (rev 219)
     pyvista  {0.33.3 (conda-forge/noarch) -> 0.36.1 (conda-forge/noarch)}
     pyviz_comms  {2.2.0 (conda-forge/noarch) -> 2.2.1 (conda-forge/noarch)}

2022-08-28 17:57:09  (rev 220)
     pytz  {2021.3 (conda-forge/noarch) -> 2022.2.1 (conda-forge/noarch)}
     pywinpty  {2.0.5 (conda-forge/win-64) -> 2.0.7 (conda-forge/win-64)}

2022-08-28 17:58:22  (rev 221)
     pyscaffold  {4.2.1 (conda-forge/noarch) -> 4.3 (conda-forge/noarch)}
     pyscaffoldext-dsproject  {0.7.1 (conda-forge/noarch) -> 0.7.2 (conda-forge/noarch)}
     pyscaffoldext-markdown  {0.4.1 (conda-forge/noarch) -> 0.5 (conda-forge/noarch)}
    +markdown-it-py-2.1.0 (conda-forge/noarch)
    +mdit-py-plugins-0.3.0 (conda-forge/noarch)
    +mdurl-0.1.0 (conda-forge/noarch)
    +myst-parser-0.18.0 (conda-forge/noarch)

2022-08-28 17:59:26  (rev 222)
     dtaidistance  {2.3.6 (conda-forge/win-64) -> 2.3.9 (conda-forge/win-64)}

2022-08-28 18:00:36  (rev 223)
     objprint  {0.2.1 (conda-forge/noarch) -> 0.2.2 (conda-forge/noarch)}

2022-08-28 18:01:34  (rev 224)
     filelock  {3.6.0 (conda-forge/noarch) -> 3.8.0 (conda-forge/noarch)}

2022-08-28 18:07:35  (rev 225)
     orjson  {3.6.7 (conda-forge/win-64) -> 3.8.0 (conda-forge/win-64)}
     partd  {1.2.0 (conda-forge/noarch) -> 1.3.0 (conda-forge/noarch)}
     pdir2  {0.3.4 (conda-forge/win-64) -> 0.3.5 (conda-forge/win-64)}

2022-08-28 18:08:28  (rev 226)
     macholib  {1.14 (conda-forge/noarch) -> 1.16 (conda-forge/noarch)}

2022-08-28 18:09:41  (rev 227)
     pluggy  {0.13.1 (conda-forge/win-64) -> 1.0.0 (conda-forge/win-64)}
     polars  {0.13.58 (conda-forge/win-64) -> 0.14.5 (conda-forge/win-64)}

2022-08-28 18:11:57  (rev 228)
     libxml2  {2.9.12 (conda-forge/win-64) -> 2.9.14 (conda-forge/win-64)}
     proj  {8.2.1 (conda-forge/win-64) -> 9.0.0 (conda-forge/win-64)}
     vispy  {0.9.6 (conda-forge/win-64) -> 0.11.0 (conda-forge/win-64)}
     vtk  {9.1.0 (conda-forge/win-64) -> 9.1.0 (conda-forge/win-64)}

2022-08-28 18:13:30  (rev 229)
     xarray  {2022.3.0 (conda-forge/noarch) -> 2022.6.0 (conda-forge/noarch)}
     yarl  {1.7.2 (conda-forge/win-64) -> 1.7.2 (conda-forge/win-64)}
     zict  {2.1.0 (conda-forge/noarch) -> 2.2.0 (conda-forge/noarch)}
     zipp  {3.7.0 (conda-forge/noarch) -> 3.8.1 (conda-forge/noarch)}

2022-08-28 18:14:26  (rev 230)
     bleach  {4.1.0 (conda-forge/noarch) -> 5.0.1 (conda-forge/noarch)}

2022-08-28 18:15:36  (rev 231)
     pybcj  {0.5.0 (conda-forge/win-64) -> 1.0.1 (conda-forge/win-64)}

2022-08-28 18:17:27  (rev 232)
     tzdata  {2021e (conda-forge/noarch) -> 2022c (conda-forge/noarch)}

2022-08-28 18:18:30  (rev 233)
     trimesh  {3.10.2 (conda-forge/noarch) -> 3.14.0 (conda-forge/noarch)}

2022-08-28 18:24:20  (rev 234)
     aeppl  {0.0.18 (conda-forge/noarch) -> 0.0.35 (conda-forge/noarch)}
     aesara  {2.3.2 (conda-forge/win-64) -> 2.8.2 (conda-forge/win-64)}
     pymc  {4.0.0b1 (conda-forge/win-64) -> 4.1.7 (conda-forge/noarch)}
    +aeppl-base-0.0.35 (conda-forge/noarch)
    +aesara-base-2.8.2 (conda-forge/win-64)
    +pymc-base-4.1.7 (conda-forge/noarch)

2022-08-28 18:25:34  (rev 235)
     atomicwrites  {1.4.0 (conda-forge/noarch) -> 1.4.1 (conda-forge/noarch)}
     attrs  {21.4.0 (conda-forge/noarch) -> 22.1.0 (conda-forge/noarch)}

2022-08-28 18:26:34  (rev 236)
     debugpy  {1.6.0 (conda-forge/win-64) -> 1.6.3 (conda-forge/win-64)}

2022-08-28 18:27:41  (rev 237)
     jsonschema  {4.7.2 (conda-forge/noarch) -> 4.14.0 (conda-forge/noarch)}
    +pkgutil-resolve-name-1.3.10 (conda-forge/noarch)

2022-08-28 18:28:50  (rev 238)
     toolz  {0.11.2 (conda-forge/noarch) -> 0.12.0 (conda-forge/noarch)}

2022-08-28 18:36:24  (rev 239)
     coverage  {6.4.3 (conda-forge/win-64) -> 6.4.4 (conda-forge/win-64)}

2022-08-28 18:37:18  (rev 240)
     importlib_resources  {5.8.0 (conda-forge/noarch) -> 5.9.0 (conda-forge/noarch)}
     ipyvuetify  {1.8.2 (conda-forge/noarch) -> 1.8.3 (conda-forge/noarch)}

2022-08-28 18:38:15  (rev 241)
     imageio  {2.19.3 (conda-forge/noarch) -> 2.21.1 (conda-forge/noarch)}
     imagesize  {1.3.0 (conda-forge/noarch) -> 1.4.1 (conda-forge/noarch)}
     iminuit  {2.10.0 (conda-forge/win-64) -> 2.16.0 (conda-forge/win-64)}

2022-08-28 18:39:15  (rev 242)
     bokeh  {2.4.2 (conda-forge/win-64) -> 2.4.3 (conda-forge/noarch)}
     colorama  {0.4.4 (conda-forge/noarch) -> 0.4.5 (conda-forge/noarch)}

2022-08-28 18:40:36  (rev 243)
     distlib  {0.3.4 (conda-forge/noarch) -> 0.3.5 (conda-forge/noarch)}
     virtualenv  {20.15.1 (conda-forge/win-64) -> 20.16.3 (conda-forge/win-64)}
     werkzeug  {2.0.3 (conda-forge/noarch) -> 2.2.2 (conda-forge/noarch)}

2022-08-28 18:41:38  (rev 244)
     docutils  {0.17.1 (conda-forge/win-64) -> 0.18.1 (conda-forge/win-64)}
     sphinx  {4.5.0 (conda-forge/noarch) -> 5.1.1 (conda-forge/noarch)}

2022-08-28 18:42:45  (rev 245)
     pefile  {2021.9.3 (conda-forge/noarch) -> 2022.5.30 (conda-forge/noarch)}

2022-08-29 19:28:07  (rev 246)
    -fabio-0.14.0 (conda-forge/win-64)
    -glymur-0.10.1 (conda-forge/noarch)
    -silx-1.0.0 (conda-forge/noarch)
    -silx-base-1.0.0 (conda-forge/win-64)

2022-08-29 19:36:44  (rev 247)
    +fabio-0.14.0 (conda-forge/win-64)
    +glymur-0.11.3 (conda-forge/noarch)

2022-08-29 19:37:38  (rev 248)
    +khronos-opencl-icd-loader-2022.05.18 (conda-forge/win-64)
    +pyopencl-2022.1.6 (conda-forge/win-64)
    +pytools-2022.1.12 (conda-forge/noarch)

2022-08-29 19:42:57  (rev 249)
    -setuptools-65.3.0 (conda-forge/noarch)

2022-08-29 19:45:09  (rev 250)
     pandoc  {2.18 (conda-forge/win-64) -> 2.19.2 (conda-forge/win-64)}
     pytest  {6.2.5 (conda-forge/win-64) -> 7.1.2 (conda-forge/win-64)}
    +nbsphinx-0.8.9 (conda-forge/noarch)
    +pytest-xvfb-2.0.0 (conda-forge/noarch)
    +pyvirtualdisplay-3.0 (conda-forge/win-64)
    +setuptools-65.3.0 (conda-forge/noarch)

2022-08-29 19:46:41  (rev 251)
     pyinstaller-hooks-contrib  {2022.8 (conda-forge/noarch) -> 2022.9 (conda-forge/noarch)}

2022-08-29 19:55:12  (rev 252)
    -python-certifi-win32-1.2 (conda-forge/win-64)
    -wincertstore-0.2 (conda-forge/win-64)
    -wrapt-1.14.1 (conda-forge/win-64)

2022-08-29 20:04:35  (rev 253)
     numpy  {1.21.5 (conda-forge/win-64) -> 1.22.4 (conda-forge/win-64)}

2022-09-13 08:18:45  (rev 254)
     ca-certificates  {2022.6.15 (conda-forge/win-64) -> 2022.6.15.1 (conda-forge/win-64)}
     certifi  {2022.6.15 (conda-forge/noarch) -> 2022.6.15.1 (conda-forge/noarch)}
    +cairo-1.16.0 (conda-forge/win-64)
    +cairocffi-1.3.0 (conda-forge/noarch)
    +cairosvg-2.5.2 (conda-forge/noarch)
    +cssselect2-0.2.1 (conda-forge/noarch)
    +drawsvg-1.8.3 (conda-forge/noarch)
    ...
    +fontconfig-2.14.0 (conda-forge/win-64)
    +fonts-conda-ecosystem-1 (conda-forge/noarch)
    +fonts-conda-forge-1 (conda-forge/noarch)
    +gettext-0.19.8.1 (conda-forge/win-64)
    +libglib-2.72.1 (conda-forge/win-64)
    +pixman-0.40.0 (conda-forge/win-64)
    +svg.py-1.3.0 (conda-forge/noarch)

2022-09-22 15:49:37  (rev 255)
     ca-certificates  {2022.6.15.1 (conda-forge/win-64) -> 2022.9.14 (conda-forge/win-64)}
     certifi  {2022.6.15.1 (conda-forge/noarch) -> 2022.9.14 (conda-forge/noarch)}
     ipyvuetify  {1.8.3 (conda-forge/noarch) -> 1.8.4 (conda-forge/noarch)}
     ipywidgets  {8.0.1 (conda-forge/noarch) -> 8.0.2 (conda-forge/noarch)}
     jupyterlab  {3.4.5 (conda-forge/noarch) -> 3.4.7 (conda-forge/noarch)}
     jupyterlab_widgets  {3.0.2 (conda-forge/noarch) -> 3.0.3 (conda-forge/noarch)}
     nbclient  {0.6.7 (conda-forge/noarch) -> 0.6.8 (conda-forge/noarch)}
     nbformat  {5.4.0 (conda-forge/noarch) -> 5.6.0 (conda-forge/noarch)}
    -click-8.1.3 (conda-forge/win-64)

2022-09-22 15:50:07  (rev 256)
     ipykernel  {6.15.1 (conda-forge/noarch) -> 6.15.3 (conda-forge/noarch)}
     ipython  {8.4.0 (conda-forge/win-64) -> 8.5.0 (conda-forge/noarch)}

2022-09-22 15:53:14  (rev 257)
     charset-normalizer  {2.0.12 (conda-forge/noarch) -> 2.1.1 (conda-forge/noarch)}
     cloudpickle  {2.1.0 (conda-forge/noarch) -> 2.2.0 (conda-forge/noarch)}
     conda-package-handling  {1.8.1 (conda-forge/win-64) -> 1.9.0 (conda-forge/win-64)}
     requests  {2.27.1 (conda-forge/noarch) -> 2.28.1 (conda-forge/noarch)}
     vs2015_runtime  {14.29.30037 (conda-forge/win-64) -> 14.29.30139 (conda-forge/win-64)}

2022-09-22 15:57:38  (rev 258)
     openpyxl  {3.0.9 (conda-forge/noarch) -> 3.0.10 (conda-forge/win-64)}
     pandas  {1.4.3 (conda-forge/win-64) -> 1.5.0 (conda-forge/win-64)}
     pyscaffold  {4.3 (conda-forge/noarch) -> 4.3.1 (conda-forge/noarch)}
     pytest  {7.1.2 (conda-forge/win-64) -> 7.1.3 (conda-forge/win-64)}
     pythreejs  {2.4.0 (conda-forge/noarch) -> 2.4.1 (conda-forge/noarch)}
     qscintilla2  {2.11.2 (conda-forge/win-64) -> 2.11.2 (conda-forge/win-64)}
     ...
     sqlite  {3.39.1 (conda-forge/win-64) -> 3.39.3 (conda-forge/win-64)}
     stack_data  {0.2.0 (conda-forge/noarch) -> 0.5.0 (conda-forge/noarch)}
     tox  {3.25.1 (conda-forge/noarch) -> 3.26.0 (conda-forge/noarch)}
     typed-ast  {1.5.2 (conda-forge/win-64) -> 1.5.4 (conda-forge/win-64)}
     virtualenv  {20.16.3 (conda-forge/win-64) -> 20.16.5 (conda-forge/win-64)}
     widgetsnbextension  {4.0.2 (conda-forge/noarch) -> 4.0.3 (conda-forge/noarch)}
    +libsqlite-3.39.3 (conda-forge/win-64)

2022-09-22 18:47:48  (rev 259)
     pyopencl  {2022.1.6 (conda-forge/win-64) -> 2022.2.3 (conda-forge/win-64)}
     pyparsing  {3.0.7 (conda-forge/noarch) -> 3.0.9 (conda-forge/noarch)}
     pyppmd  {0.18.1 (conda-forge/win-64) -> 1.0.0 (conda-forge/win-64)}
     python-blosc  {1.10.2 (conda-forge/win-64) -> 1.10.6 (conda-forge/win-64)}
     python-fastjsonschema  {2.15.3 (conda-forge/noarch) -> 2.16.2 (conda-forge/noarch)}
     python-slugify  {6.1.1 (conda-forge/noarch) -> 6.1.2 (conda-forge/noarch)}
     python-utils  {3.1.0 (conda-forge/noarch) -> 3.3.3 (conda-forge/noarch)}
     pywavelets  {1.2.0 (conda-forge/win-64) -> 1.3.0 (conda-forge/win-64)}
     pywinpty  {2.0.7 (conda-forge/win-64) -> 2.0.8 (conda-forge/win-64)}
     pyzmq  {23.1.0 (conda-forge/win-64) -> 24.0.1 (conda-forge/win-64)}
     pyzstd  {0.15.1 (conda-forge/win-64) -> 0.15.3 (conda-forge/win-64)}

2022-09-22 22:28:52  (rev 260)
     babel  {2.9.1 (conda-forge/noarch) -> 2.10.3 (conda-forge/noarch)}
     bqplot  {0.12.34 (conda-forge/noarch) -> 0.12.36 (conda-forge/noarch)}
     c-blosc2  {2.3.1 (conda-forge/win-64) -> 2.4.1 (conda-forge/win-64)}
     cffi  {1.15.0 (conda-forge/win-64) -> 1.15.1 (conda-forge/win-64)}
     cftime  {1.5.2 (conda-forge/win-64) -> 1.6.2 (conda-forge/win-64)}

2022-09-22 22:40:11  (rev 261)
     abseil-cpp  {20211102.0 (conda-forge/win-64) -> 20220623.0 (conda-forge/win-64)}
     arrow-cpp  {9.0.0 (conda-forge/win-64) -> 9.0.0 (conda-forge/win-64)}
     expat  {2.4.8 (conda-forge/win-64) -> 2.4.9 (conda-forge/win-64)}
     fastapi  {0.81.0 (conda-forge/noarch) -> 0.85.0 (conda-forge/noarch)}
     fastcore  {1.5.22 (conda-forge/noarch) -> 1.5.26 (conda-forge/noarch)}
     fsspec  {2022.7.1 (conda-forge/noarch) -> 2022.8.2 (conda-forge/noarch)}
     grpc-cpp  {1.46.4 (conda-forge/win-64) -> 1.46.4 (conda-forge/win-64)}
     grpcio  {1.45.0 (conda-forge/win-64) -> 1.46.4 (conda-forge/win-64)}
     joblib  {1.1.0 (conda-forge/noarch) -> 1.2.0 (conda-forge/noarch)}
     libgoogle-cloud  {1.40.2 (conda-forge/win-64) -> 2.1.0 (conda-forge/win-64)}
     pyarrow  {9.0.0 (conda-forge/win-64) -> 9.0.0 (conda-forge/win-64)}
     starlette  {0.19.1 (conda-forge/noarch) -> 0.20.4 (conda-forge/noarch)}
    +libabseil-20220623.0 (conda-forge/win-64)

2022-09-22 22:56:55  (rev 262)
     cupy  {11.0.0 (conda-forge/win-64) -> 11.1.0 (conda-forge/win-64)}

2022-09-22 23:23:37  (rev 263)
     mako  {1.2.1 (conda-forge/noarch) -> 1.2.3 (conda-forge/noarch)}
     menuinst  {1.4.18 (conda-forge/win-64) -> 1.4.19 (conda-forge/win-64)}
     msgpack-python  {1.0.3 (conda-forge/win-64) -> 1.0.4 (conda-forge/win-64)}
     nest-asyncio  {1.5.4 (conda-forge/noarch) -> 1.5.5 (conda-forge/noarch)}
     netcdf4  {1.5.8 (conda-forge/win-64) -> 1.6.0 (conda-forge/win-64)}
     neurodsp  {2.1.0 (conda-forge/noarch) -> 2.2.0 (conda-forge/noarch)}
     param  {1.12.0 (conda-forge/noarch) -> 1.12.2 (conda-forge/noarch)}

2022-10-03 17:00:17  (rev 264)
     ca-certificates  {2022.9.14 (conda-forge/win-64) -> 2022.9.24 (conda-forge/win-64)}
     certifi  {2022.9.14 (conda-forge/noarch) -> 2022.9.24 (conda-forge/noarch)}
    +pypdf2-2.10.8 (conda-forge/noarch)

2022-10-03 17:34:10  (rev 265)
    +img2pdf-0.4.4 (conda-forge/win-64)
    +reportlab-3.5.68 (conda-forge/win-64)
    +svg42pdf-0.2.2 (conda-forge/noarch)

2022-10-03 18:46:20  (rev 266)
    +custom-inherit-2.4.0 (conda-forge/noarch)
    +natsort-8.2.0 (conda-forge/noarch)
    +pylustrator-1.1.2 (conda-forge/noarch)
    +pypng-0.20220715.0 (conda-forge/noarch)
    +tikzplotlib-0.10.1 (conda-forge/noarch)
    +toyplot-1.0.1 (conda-forge/noarch)
    +toytree-2.0.5 (conda-forge/noarch)
    +webcolors-1.12 (conda-forge/noarch)

2022-10-03 18:57:29  (rev 267)
    +mpltoolbox-0.1 (conda-forge/noarch)

2022-10-03 18:59:55  (rev 268)
    +adjusttext-0.7.3.1 (conda-forge/noarch)
    +mpl-template-0.3.1 (conda-forge/noarch)

2022-10-03 19:03:44  (rev 269)
    +mpl-qtthread-0.0.1 (conda-forge/noarch)

2022-10-03 19:06:11  (rev 270)
    +lovelyplots-0.0.26 (conda-forge/noarch)

2022-10-03 19:11:54  (rev 271)
    +itemadapter-0.7.0 (conda-forge/noarch)

2022-10-03 19:14:07  (rev 272)
    +fast-histogram-0.10 (conda-forge/win-64)
    +mpl-multitab-0.0.1 (conda-forge/noarch)
    +mpl-point-clicker-0.3.1 (conda-forge/noarch)
    +mpl-scatter-density-0.7 (conda-forge/noarch)

2022-10-04 11:05:17  (rev 273)
    +pdfminer.six-20220524 (conda-forge/noarch)

2022-10-04 15:39:05  (rev 274)
    +piso-0.9.0 (conda-forge/noarch)
    +portion-2.3.0 (conda-forge/noarch)
    +staircase-2.4.2 (conda-forge/noarch)

2022-10-11 03:23:33  (rev 275)
     boa  {0.11.0 (conda-forge/noarch) -> 0.12.0 (conda-forge/noarch)}
     ...
     libmamba  {0.25.0 (conda-forge/win-64) -> 0.27.0 (conda-forge/win-64)}
     libmambapy  {0.25.0 (conda-forge/win-64) -> 0.27.0 (conda-forge/win-64)}
     mamba  {0.25.0 (conda-forge/win-64) -> 0.27.0 (conda-forge/win-64)}

2022-10-11 03:27:27  (rev 276)
     ipykernel  {6.15.3 (conda-forge/noarch) -> 6.16.0 (conda-forge/noarch)}

2022-10-11 03:28:53  (rev 277)
     cupy  {11.1.0 (conda-forge/win-64) -> 11.2.0 (conda-forge/win-64)}
     docutils  {0.18.1 (conda-forge/win-64) -> 0.19 (conda-forge/win-64)}
     loky  {3.1.0 (conda-forge/noarch) -> 3.3.0 (conda-forge/noarch)}
     mdit-py-plugins  {0.3.0 (conda-forge/noarch) -> 0.3.1 (conda-forge/noarch)}
     myst-parser  {0.18.0 (conda-forge/noarch) -> 0.18.1 (conda-forge/noarch)}
     nbclient  {0.6.8 (conda-forge/noarch) -> 0.7.0 (conda-forge/noarch)}

2022-10-11 03:32:46  (rev 278)
     fontconfig  {2.14.0 (conda-forge/win-64) -> 2.14.0 (conda-forge/win-64)}
     gettext  {0.19.8.1 (conda-forge/win-64) -> 0.19.8.1 (conda-forge/win-64)}
     google-auth  {2.6.2 (conda-forge/noarch) -> 2.12.0 (conda-forge/noarch)}
     goosehdf5  {0.17.1 (conda-forge/noarch) -> 0.20.3 (conda-forge/noarch)}
     importlib_resources  {5.9.0 (conda-forge/noarch) -> 5.10.0 (conda-forge/noarch)}
     jupyter_server  {1.18.1 (conda-forge/noarch) -> 1.19.1 (conda-forge/noarch)}
     jupyterlab  {3.4.7 (conda-forge/noarch) -> 3.4.8 (conda-forge/noarch)}
     jupyterlab_server  {2.15.1 (conda-forge/noarch) -> 2.15.2 (conda-forge/noarch)}
     libglib  {2.72.1 (conda-forge/win-64) -> 2.74.0 (conda-forge/win-64)}
     libiconv  {1.16 (conda-forge/win-64) -> 1.17 (conda-forge/win-64)}
     libxslt  {1.1.33 (conda-forge/win-64) -> 1.1.35 (conda-forge/win-64)}
    +click-8.1.3 (conda-forge/win-64)
    +pcre2-10.37 (conda-forge/win-64)
    +prettytable-3.4.1 (conda-forge/noarch)
    +termcolor-2.0.1 (conda-forge/noarch)

2022-10-11 03:34:04  (rev 279)
     blinker  {1.4 (conda-forge/noarch) -> 1.5 (conda-forge/noarch)}
     coverage  {6.4.4 (conda-forge/win-64) -> 6.5.0 (conda-forge/win-64)}
     dask  {2022.8.1 (conda-forge/noarch) -> 2022.9.2 (conda-forge/noarch)}
     dask-core  {2022.8.1 (conda-forge/noarch) -> 2022.9.2 (conda-forge/noarch)}
     distributed  {2022.8.1 (conda-forge/noarch) -> 2022.9.2 (conda-forge/noarch)}
     dtaidistance  {2.3.9 (conda-forge/win-64) -> 2.3.10 (conda-forge/win-64)}
     etuples  {0.3.5 (conda-forge/noarch) -> 0.3.8 (conda-forge/noarch)}
     executing  {0.10.0 (conda-forge/noarch) -> 1.1.1 (conda-forge/noarch)}

2022-10-11 03:38:50  (rev 280)
     depinfo  {2.1.1 (conda-forge/noarch) -> 2.2.0 (conda-forge/noarch)}
     gdown  {4.4.0 (conda-forge/noarch) -> 4.5.1 (conda-forge/noarch)}
     imagecodecs  {2022.8.8 (conda-forge/win-64) -> 2022.9.26 (conda-forge/win-64)}
...
2022-10-11 03:42:35  (rev 281)
     ipyvue  {1.7.0 (conda-forge/noarch) -> 1.8.0 (conda-forge/noarch)}
     matplotlib-inline  {0.1.3 (conda-forge/noarch) -> 0.1.6 (conda-forge/noarch)}
     nbclassic  {0.4.3 (conda-forge/noarch) -> 0.4.5 (conda-forge/noarch)}
     nbconvert  {7.0.0 (conda-forge/noarch) -> 7.2.1 (conda-forge/noarch)}
     nbconvert-core  {7.0.0 (conda-forge/noarch) -> 7.2.1 (conda-forge/noarch)}
     nbconvert-pandoc  {7.0.0 (conda-forge/noarch) -> 7.2.1 (conda-forge/noarch)}
     nbformat  {5.6.0 (conda-forge/noarch) -> 5.7.0 (conda-forge/noarch)}
     nest-asyncio  {1.5.5 (conda-forge/noarch) -> 1.5.6 (conda-forge/noarch)}

2022-10-11 03:43:59  (rev 282)
     setuptools  {65.3.0 (conda-forge/noarch) -> 65.4.1 (conda-forge/noarch)}

2022-10-11 04:27:17  (rev 283)
     c-blosc2  {2.4.1 (conda-forge/win-64) -> 2.4.2 (conda-forge/win-64)}
     colorcet  {3.0.0 (conda-forge/noarch) -> 3.0.1 (conda-forge/noarch)}

2022-10-11 04:29:01  (rev 284)
     hyperopt  {0.2.5 (conda-forge/noarch) -> 0.2.7 (conda-forge/noarch)}
     idna  {3.3 (conda-forge/noarch) -> 3.4 (conda-forge/noarch)}
     iminuit  {2.16.0 (conda-forge/win-64) -> 2.17.0 (conda-forge/win-64)}
     libarchive  {3.5.2 (conda-forge/win-64) -> 3.5.2 (conda-forge/win-64)}
     libnetcdf  {4.8.1 (conda-forge/win-64) -> 4.8.1 (conda-forge/win-64)}
     libprotobuf  {3.20.1 (conda-forge/win-64) -> 3.20.1 (conda-forge/win-64)}
     libsqlite  {3.39.3 (conda-forge/win-64) -> 3.39.4 (conda-forge/win-64)}
     libuv  {1.43.0 (conda-forge/win-64) -> 1.44.2 (conda-forge/win-64)}
     libxml2  {2.9.14 (conda-forge/win-64) -> 2.10.2 (conda-forge/win-64)}
     libzip  {1.8.0 (conda-forge/win-64) -> 1.9.2 (conda-forge/win-64)}
     llvmlite  {0.38.1 (conda-forge/win-64) -> 0.39.1 (conda-forge/win-64)}
     loguru  {0.5.3 (conda-forge/win-64) -> 0.6.0 (conda-forge/win-64)}
     lxml  {4.8.0 (conda-forge/win-64) -> 4.9.1 (conda-forge/win-64)}
     macholib  {1.16 (conda-forge/noarch) -> 1.16.2 (conda-forge/noarch)}
     numba  {0.55.2 (conda-forge/win-64) -> 0.56.2 (conda-forge/win-64)}
     sqlite  {3.39.3 (conda-forge/win-64) -> 3.39.4 (conda-forge/win-64)}
    +py4j-0.10.9.7 (conda-forge/noarch)

2022-10-11 04:33:12  (rev 285)
     pathspec  {0.9.0 (conda-forge/noarch) -> 0.10.1 (conda-forge/noarch)}
     psutil  {5.9.0 (conda-forge/win-64) -> 5.9.2 (conda-forge/win-64)}

2022-10-11 04:38:19  (rev 286)
     pyqt-builder  {1.13.0 (conda-forge/noarch) -> 1.14.0 (conda-forge/noarch)}
     pytest-cov  {3.0.0 (conda-forge/noarch) -> 4.0.0 (conda-forge/noarch)}
     scipy  {1.9.0 (conda-forge/win-64) -> 1.9.1 (conda-forge/win-64)}
     seaborn  {0.11.2 (conda-forge/noarch) -> 0.12.0 (conda-forge/noarch)}
     seaborn-base  {0.11.2 (conda-forge/noarch) -> 0.12.0 (conda-forge/noarch)}
     sip  {6.6.2 (conda-forge/win-64) -> 6.7.1 (conda-forge/win-64)}

2022-10-11 18:14:53  (rev 287)
    +echo-0.5 (conda-forge/noarch)
    +glue-core-1.5.0 (conda-forge/win-64)
    +glue-vispy-viewers-1.0.4 (conda-forge/noarch)
    +glueviz-1.2.0 (conda-forge/win-64)

2022-10-12 09:16:31  (rev 288)
    +haesleinhuepf-pyqode.core-2.15.5 (conda-forge/noarch)
    +haesleinhuepf-pyqode.python-2.15.2 (conda-forge/noarch)
    +pycodestyle-2.9.1 (conda-forge/noarch)
    +pyflakes-2.5.0 (conda-forge/noarch)

2022-10-12 09:19:27  (rev 289)
    +pyqode.qt-2.10.0 (conda-forge/noarch)

2022-10-12 16:49:10  (rev 290)
    -pyqode.qt-2.10.0 (conda-forge/noarch)

2022-10-12 16:53:55  (rev 291)
    -haesleinhuepf-pyqode.core-2.15.5 (conda-forge/noarch)
    -haesleinhuepf-pyqode.python-2.15.2 (conda-forge/noarch)
    -pycodestyle-2.9.1 (conda-forge/noarch)
    -pyflakes-2.5.0 (conda-forge/noarch)

2022-10-12 23:43:01  (rev 292)
     vispy  {0.11.0 (conda-forge/win-64) -> 0.10.0 (conda-forge/win-64)}
    +asciitree-0.3.3 (conda-forge/noarch)
    +autopep8-1.7.0 (conda-forge/noarch)
    +cachey-0.2.1 (conda-forge/noarch)
    +docstring_parser-0.13 (conda-forge/noarch)
    +fasteners-0.17.3 (conda-forge/noarch)
    +ipycanvas-0.13.1 (conda-forge/noarch)
    +ipyevents-2.0.1 (conda-forge/noarch)
    +magicgui-0.5.1 (conda-forge/noarch)
    +napari-0.4.16 (conda-forge/noarch)
    +napari-assistant-0.3.16 (conda-forge/noarch)
    +napari-console-0.0.6 (conda-forge/noarch)
    +napari-cupy-image-processing-0.3.1 (conda-forge/noarch)
    +napari-plugin-engine-0.2.0 (conda-forge/noarch)
    +napari-skimage-regionprops-0.5.4 (conda-forge/noarch)
    +napari-svg-0.1.6 (conda-forge/noarch)
    +napari-time-slicer-0.4.9 (conda-forge/noarch)
    +napari-tools-menu-0.1.17 (conda-forge/noarch)
    +napari-workflows-0.2.6 (conda-forge/noarch)
    +npe2-0.6.1 (conda-forge/noarch)
    +numcodecs-0.10.2 (conda-forge/win-64)
    +pep517-0.12.0 (conda-forge/win-64)
    +pint-0.19.2 (conda-forge/noarch)
    +pooch-1.6.0 (conda-forge/noarch)
    +psygnal-0.3.5 (conda-forge/win-64)
    +pycodestyle-2.9.1 (conda-forge/noarch)
    +pyperclip-1.8.2 (conda-forge/noarch)
    +python-build-0.8.0 (conda-forge/noarch)
    +pytomlpp-1.0.11 (conda-forge/win-64)
    +shellingham-1.5.0 (conda-forge/noarch)
    +stackview-0.3.5 (conda-forge/noarch)
    +superqt-0.3.8 (conda-forge/noarch)
    +typer-0.6.1 (conda-forge/noarch)
    +wrapt-1.14.1 (conda-forge/win-64)
    +zarr-2.13.3 (conda-forge/noarch)

2022-10-22 02:52:20  (rev 293)
     jupyter_server  {1.19.1 (conda-forge/noarch) -> 1.21.0 (conda-forge/noarch)}
     jupyterlab_server  {2.15.2 (conda-forge/noarch) -> 2.16.1 (conda-forge/noarch)}
     openssl  {1.1.1q (conda-forge/win-64) -> 1.1.1q (conda-forge/win-64)}

2022-10-23 15:36:52  (rev 294)
     aiohttp  {3.8.1 (conda-forge/win-64) -> 3.8.3 (conda-forge/win-64)}
     ipykernel  {6.16.0 (conda-forge/noarch) -> 6.16.1 (conda-forge/noarch)}
     nbclassic  {0.4.5 (conda-forge/noarch) -> 0.4.7 (conda-forge/noarch)}
     nbconvert  {7.2.1 (conda-forge/noarch) -> 7.2.2 (conda-forge/noarch)}
     nbconvert-core  {7.2.1 (conda-forge/noarch) -> 7.2.2 (conda-forge/noarch)}
     nbconvert-pandoc  {7.2.1 (conda-forge/noarch) -> 7.2.2 (conda-forge/noarch)}

2022-10-26 18:56:57  (rev 295)
    +flask-2.2.2 (conda-forge/noarch)
    +flask-compress-1.13 (conda-forge/noarch)
    +hiplot-0.1.33 (conda-forge/noarch)
    +itsdangerous-2.1.2 (conda-forge/noarch)

2022-11-01 13:40:53  (rev 296)
    -matplotlib-base-3.4.3 (conda-forge/win-64)
    +boto3-1.25.5 (conda-forge/noarch)
    +botocore-1.28.5 (conda-forge/noarch)
    +ftfy-6.1.1 (conda-forge/noarch)
    +jmespath-1.0.1 (conda-forge/noarch)
    +mailchecker-4.1.19 (conda-forge/noarch)
    +phonenumbers-8.12.57 (conda-forge/noarch)
    +python-benedict-0.27.0 (conda-forge/noarch)
    +python-fsutil-0.7.0 (conda-forge/noarch)
    +s3transfer-0.6.0 (conda-forge/noarch)
    +xmldiff-2.4 (conda-forge/noarch)
    +xmltodict-0.13.0 (conda-forge/noarch)

2022-11-03 16:52:54  (rev 297)
     ipykernel  {6.16.1 (conda-forge/noarch) -> 6.17.0 (conda-forge/noarch)}
     ipython  {8.5.0 (conda-forge/noarch) -> 8.6.0 (conda-forge/noarch)}
     openssl  {1.1.1q (conda-forge/win-64) -> 1.1.1s (conda-forge/win-64)}
    -protobuf-3.20.1 (conda-forge/win-64)
    -tensorboard-2.8.0 (conda-forge/noarch)

2022-11-04 19:35:50  (rev 298)
     jupyterlab  {3.4.8 (conda-forge/noarch) -> 3.5.0 (conda-forge/noarch)}

2022-11-08 10:59:09  (rev 299)
    -fast-histogram-0.10 (conda-forge/win-64)
    -mpl-multitab-0.0.1 (conda-forge/noarch)

2022-11-08 15:22:49  (rev 300)
    +pympler-1.0.1 (conda-forge/noarch)

2022-11-08 19:50:52  (rev 301)
     pandas  {1.5.0 (conda-forge/win-64) -> 1.5.1 (conda-forge/win-64)}
     staircase  {2.4.2 (conda-forge/noarch) -> 2.5.0 (conda-forge/noarch)}
    +contourpy-1.0.6 (conda-forge/win-64)
    +fonttools-4.38.0 (conda-forge/win-64)
    +matplotlib-base-3.6.2 (conda-forge/win-64)
